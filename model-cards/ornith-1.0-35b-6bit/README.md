...
of [Deep Reinforce AI's Ornith-1.0-35B][upstream]. It is intended for local
agentic coding on Apple Silicon through [Geer][geer].
...
- Converted size: 29,090,323,784 bytes (approximately 27.1 GiB)
...
See the [Geer README][geer] for the current T3 Code and Claude Code proof of
...
[model card][upstream]. Geer has verified that this conversion loads and works

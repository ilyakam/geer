...
conversion of [Ornith-1.5-35B-A3B][upstream]. It is intended for local agentic
coding on Apple Silicon through [Geer][geer]. The model identity is
intentionally transparent: this is Ornith-1.5-35B-A3B converted by Geer, not a
